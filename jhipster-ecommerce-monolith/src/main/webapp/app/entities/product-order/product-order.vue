      ...
      <table class="table table-striped" aria-describedby="productOrders">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('storeApp.productOrder.quantity')">Quantity</span></th>
            <th scope="row"><span v-text="$t('storeApp.productOrder.totalPrice')">Total Price</span></th>
            <th scope="row"><span v-text="$t('storeApp.productOrder.product')">Product</span></th>
            <th scope="row"><span v-text="$t('storeApp.productOrder.cart')">Cart</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
