    ...
    <div class="col-8">
      <div v-if="productOrder">
        ...
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('storeApp.productOrder.quantity')">Quantity</span>
          </dt>
          <dd>
            <span>{{ productOrder.quantity }}</span>
          </dd>
          <dt>
            <span v-text="$t('storeApp.productOrder.totalPrice')">Total Price</span>
          </dt>
          <dd>
            <span>{{ productOrder.totalPrice }}</span>
          </dd>
          <dt>
            <span v-text="$t('storeApp.productOrder.product')">Product</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('storeApp.productOrder.cart')">Cart</span>
          </dt>
          <dd>
